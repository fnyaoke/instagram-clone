...
#import Image re-sizers, (Can translate large image to a small one when called in another location where it is needed in a smaller version.)
from django.db.models.signals import post_save
from django.dispatch import receiver

# Create your models here.

#adding a class for profiles
...
#Attribute Variables for Profile class to represent different columns in database
    ...
    used especially in comment section to display profile photo)
...
#Attribute Variables for Image class to represent different columns in database
    ...
    -date-: imported as a django relative import ('from django.contrib.auth.models import User'))
        set to auto using python model, this allows for date to be added automatically
